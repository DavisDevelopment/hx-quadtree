...
class TestQuadTreeAddRemove extends QuadTree implements ITest
{
    public function new()
    {
        super(0, 0, 0, 0);
    ...
    function testAddHereRemove()
    {
        ...
        Assert.equals(0, objects0Length);
    }
    ...
    function testAddRemove()
    {
        var boxes: Array<Box> = [
            new Box(0, 0, 100, 100),
            new Box(200, 0, 100, 100),
            new Box(200, 200, 100, 100),
            new Box(500, 200, 100, 100),
            new Box(200, 700, 100, 100),
            new Box(600, 200, 100, 100),
            new Box(800, 800, 100, 100)
        ];
        ...
        for (i in 0...boxes.length)
        {
            ...
            Assert.equals(i+1, countObjectsInTree());
        }
        ...
        for (i in 0...boxes.length)
        {
            ...
            Assert.equals(boxes.length - i - 1, countObjectsInTree());
        }
    }
    ...
    function countObjectsInTree(): Int
    {
        var count: Int = 0;

        traverseAllRecursive(this, qt ->
        {
            count += qt.objects0Length;
            count += qt.objects1Length;
        });
